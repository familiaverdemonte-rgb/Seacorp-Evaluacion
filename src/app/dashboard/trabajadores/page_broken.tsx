...
export default function TrabajadoresPage() {
  ...
  const loadTrabajadores = async () => {
    try {
      ...
      setFilteredTrabajadores(data) // Inicializar filteredTrabajadores
    } catch (error) {
  ...
  const handleDelete = async (trabajador: Trabajador) => {
    ...
    try {
      ...
      // Verificar si el trabajador tiene evaluaciones asociadas
      ...
      if (evaluacionesDelTrabajador.length > 0) {
        // Agrupar evaluaciones por ciclo para mostrar información detallada
      ...
      // Si no tiene evaluaciones, proceder con la eliminación
